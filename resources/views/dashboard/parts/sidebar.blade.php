<aside class="sidebar-wrapper" data-simplebar="init">
                        ...
                        <ul class="metismenu mm-show" id="menu">
                            <li class="mm-active">
                                ...
                                <ul class="mm-show mm-collapse">
                                    <li class="mm-active"> <a href="index.html" aria-expanded="true"><i
                                                class="bi bi-circle"></i>Blue Dashboard</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="mm-collapse">
                                    <li> <a href="{{ route('dash.grade.index') }}"><i class="bi bi-circle"></i>جميع
                                            المستويات
                                        </a>
                                    </li>
                                    {{-- <li> <a href="{{route('dash.grade.create')}}"><i class="bi bi-circle"></i>إضافة مستوى جديد
                                            </a>
                                    </li> --}}
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="mm-collapse">
                                    <li> <a href="{{route('dash.sections.index')}}"><i class="bi bi-circle"></i>جميع الشعب
                                            </a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="mm-collapse">
                                    ...
                                    <li> <a href="icons-feather-icons.html"><i class="bi bi-circle"></i>Feather
                                            Icons</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="mm-collapse">
                                    ...
                                    <li> <a href="form-validations.html"><i class="bi bi-circle"></i>Form
                                            Validation</a>
                                    </li>
                                    <li> <a href="form-wizard.html"><i class="bi bi-circle"></i>Form Wizard</a>
                                    </li>
                                    <li> <a href="form-date-time-pickes.html"><i class="bi bi-circle"></i>Date
                                            Pickers</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="mm-collapse">
                                    ...
                                    <li> <a href="table-advance-tables.html"><i class="bi bi-circle"></i>Advance
                                            Tables</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="mm-collapse">
                                    <li> <a href="authentication-signin.html" target="_blank"><i
                                                class="bi bi-circle"></i>Sign In</a>
                                    </li>
                                    <li> <a href="authentication-signup.html" target="_blank"><i
                                                class="bi bi-circle"></i>Sign Up</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="mm-collapse">
                                    <li> <a href="pages-errors-404-error.html" target="_blank"><i
                                                class="bi bi-circle"></i>404 Error</a>
                                    </li>
                                    <li> <a href="pages-errors-500-error.html" target="_blank"><i
                                                class="bi bi-circle"></i>500 Error</a>
                                    </li>
                                    ...
                                    <li> <a href="pages-blank-page.html" target="_blank"><i
                                                class="bi bi-circle"></i>Blank Page</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                    ...
                                    <li> <a class="has-arrow" href="javascript:;"><i class="bi bi-circle"></i>Level
                                        ...
                                        <ul class="mm-collapse">
                                            <li> <a class="has-arrow" href="javascript:;"><i
                                                        class="bi bi-circle"></i>Level Two</a>
                                                <ul class="mm-collapse">
                                                    <li> <a href="javascript:;"><i class="bi bi-circle"></i>Level
                                                            Three</a>
                                                    </li>
                                                </ul>
                                            </li>
    ...
    <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
        <div class="simplebar-scrollbar"
            style="height: 141px; transform: translate3d(0px, 0px, 0px); display: block;"></div>
    </div>
</aside>
