                ...
                <li>
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                      <img src="{{asset('dashboard/assets/images/avatars/avatar-1.png')}}" alt="" class="rounded-circle"
                        width="54" height="54">
                      <div class="ms-3">
            ...
            <li class="nav-item dropdown dropdown-large">
              ...
              <div class="dropdown-menu dropdown-menu-end p-0">
                ...
                <div class="header-message-list p-2">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                      <img src="{{asset('dashboard/assets/images/avatars/avatar-2.png')}}" alt="" class="rounded-circle"
                        width="50" height="50">
                      <div class="ms-3 flex-grow-1">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                      <img src="{{asset('dashboard/assets/images/avatars/avatar-3.png')}}" alt="" class="rounded-circle"
                        width="50" height="50">
                      <div class="ms-3 flex-grow-1">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                      <img src="{{asset('dashboard/assets/images/avatars/avatar-4.png')}}" alt="" class="rounded-circle"
                        width="50" height="50">
                      <div class="ms-3 flex-grow-1">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                      <img src="{{asset('dashboard/assets/images/avatars/avatar-5.png')}}" alt="" class="rounded-circle"
                        width="50" height="50">
                      <div class="ms-3 flex-grow-1">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                      <img src="{{asset('dashboard/assets/images/avatars/avatar-6.png')}}" alt="" class="rounded-circle"
                        width="50" height="50">
                      <div class="ms-3 flex-grow-1">
  ...
  <script>
    $('#add-form').on('submit', function (e) {
      ...
      $.ajax({
        ...
        error: function (data) {
          if (data.status === 422) {
            // استخرج الأخطاء من استجابة السيرفر
            var response = data.responseJSON;

            // مر على كل خطأ
            $.each(response.errors, function (key, value) {
              // دعم الحقول داخل arrays مثل teachers.0.name
              var str = key.split(".");
              if (str.length > 1 && !isNaN(str[1])) {
                key = str[0] + "[" + str[1] + "]" + "[" + str[2] + "]";
              }

              // إضافة كلاس is-invalid على العنصر الذي فيه خطأ
              $('[name="' + key + '"], [name="' + key + '[]"]').addClass('is-invalid');

              // عرض الرسالة داخل العنصر .invalid-feedback القريب منه
    ...
    // هذا الكود عند الضغط على اضافة معلم يخفي الاخطا اذا اغلق وفتحت كمان مرة
    $('.btn-add').on('click', function (e) {
      $('input').removeClass('is-invalid');
      $('select').removeClass('is-invalid');
      $('.invalid-feedback').text('');
    });
    //  عند الكتابة مع ظهور رسالة الخطأ يخفي الخطأ
    $('input, select').on('input change', function () {
      $(this).removeClass('is-invalid'); // إزالة كلاس الخطأ
      $(this).next('.invalid-feedback').text(''); // إخفاء الرسالة
    });
    ...
    $(document).ready(function () {
      $('.delete-btn').on('click', function (e) {
        ...
        swal({
          ...
          text: "عند حذف العنصر لايمكن التراجع عن العملية",
          icon: "warning",
          buttons: {
            close: {
              text: "الغاء",
              value: false,       // تصحيح: vlaue → value
              visible: true,      // تصحيح: false → true لإظهار الزر
              className: "custom-cancel-btn",
              closeModal: true,   // تصحيح: closeModel → closeModal
            },
            confirm: {
              text: "إحذف",
              value: true,        // تصحيح: vlaue → value
              visible: true,      // تصحيح: false → true
